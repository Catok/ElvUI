...
function S:EmbedSkada()
	...
	elseif #skadaWindows == 2 then
		self:EmbedSkadaWindow(skadaWindows[1], ((E.db.general.panelWidth - widthOffset) * 0.55) - (borderWidth + E.mult) + 1, (E.db.general.panelHeight - ((barSpacing * skadaWindows[1].db.barheight) + barSpacing * (numBars - 1))) / numBars, E.db.general.panelHeight - heightOffset,  "BOTTOMRIGHT", RightChatToggleButton, "TOPRIGHT", -2, 6)
		self:EmbedSkadaWindow(skadaWindows[2], ((E.db.general.panelWidth - widthOffset) * 0.45) - (borderWidth + E.mult), (E.db.general.panelHeight - ((barSpacing * skadaWindows[2].db.barheight) + barSpacing * (numBars - 1))) / numBars, E.db.general.panelHeight - heightOffset,  "BOTTOMLEFT", RightChatDataPanel, "TOPLEFT", 2, 6)
	elseif #skadaWindows > 2 then
